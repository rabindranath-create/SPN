...
write.csv(result_WCSPP_RD,"result_WCSPP_RD_40_1.csv")
...
####  RD risk function ####
result_WCSPP_RD <- matrix(NA,ncol=7,nrow=100)
write.csv(result_WCSPP_RD,"result_WCSPP_RD_40_2.csv")
Update_graph_intersect<-function(g,x,y,circle_info,r){
  #read circle center x,y coordinate c-cost,p-prabability,True or False Obstacles
  #circles=read.csv("example1.csv",header=FALSE)
  n <- nrow(circle_info)
...
####  RD risk function ####
result_WCSPP_RD <- matrix(NA,ncol=7,nrow=100)
write.csv(result_WCSPP_RD,"result_WCSPP_RD_40_3.csv")
Update_graph_intersect<-function(g,x,y,circle_info,r){
  #read circle center x,y coordinate c-cost,p-prabability,True or False Obstacles
  #circles=read.csv("example1.csv",header=FALSE)
  n <- nrow(circle_info)
